...
pub const TEASPOON: UnitSimple<Volume> = UnitSimple {
    system: PhantomData,
    offset: 0.0,
    ratio: FLUID_OUNCE_CUSTOMARY.ratio / 6.0,
};

pub const TABLESPOON: UnitSimple<Volume> = UnitSimple {
    system: PhantomData,
    offset: 0.0,
    ratio: FLUID_OUNCE_CUSTOMARY.ratio / 2.0,
};

pub const CUP_CUSTOMARY: UnitSimple<Volume> = UnitSimple {
    system: PhantomData,
    offset: 0.0,
    ratio: 0.0002365882365,
};

pub const FLUID_OUNCE_CUSTOMARY: UnitSimple<Volume> = UnitSimple {
    system: PhantomData,
    offset: 0.0,
